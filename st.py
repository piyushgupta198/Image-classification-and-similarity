...
if( user_selection == "Mens"):
    MODEL_PATH = os.path.normpath(r"models\mens_model.pt")
    MENS_BASE_DIR = r"IMAGES\MENS"
elif( user_selection == "Womens"):
    MODEL_PATH = os.path.normpath(r"models\ladies_model.pt")
    MENS_BASE_DIR = r"IMAGES\WOMENS"
elif( user_selection == "Kids"):
    MODEL_PATH = os.path.normpath(r"models\kids_model.pt")
